...
\begin{itemize}
    ...
    \item \textbf{Interactive Features:} Additional interactive features such as panning, zooming, or hovering over nodes are implemented to improve code understanding and navigation within the codebase. In Figure \ref{fig:graph_visualisation}, hovering over a node displays a tooltip containing more information about the node.
    \begin{figure}[H]
        \centering
        {\small
