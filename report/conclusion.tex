...
\begin{enumerate}
    ...
    \item CodeOrient's graph visualisation was found to achieve a 93.61\% recall rate in rendering the correct nodes relevant to the user query, where it outperformed its own recall rate by inferring imported relationships that were not explicitly retrieved in the initial search results.
