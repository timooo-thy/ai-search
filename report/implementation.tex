...
The account dashboard allows users to monitor their interaction with the platform. As shown in \textit{Figure~\ref{fig:account_dashboard}}, users can view statistics such as:
\begin{itemize}
...
To facilitate collaboration, CodeOrient supports the sharing of conversations via unique read-only links. \textit{Figure~\ref{fig:sharing_conversation_link}} illustrates the shared chat view where authorised users can view the conversation history in read-only mode.
\begin{figure}[H]
    \centering
    {\small
