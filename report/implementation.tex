...
\subsubsection{LLM-Based Explanation}
\subsubsection{Citation Extraction and Grounding}

\section{API Endpoints and Data Models}

\section{Database Schema}

\section{Code Examples and Key Algorithms}
...
\subsection{RAG Citation Grounding}
...
\subsection{Language and Framework Diversity}